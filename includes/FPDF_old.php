...
function FPDF($orientation='P', $unit='mm', $size='A4')
{
	...
	else*/if(is_dir($this->getDir()."font/"))
		$this->fontpath = $this->getDir()."font/";
	else
		$this->fontpath = '';
...
function Constructor($orientation='P', $unit='mm', $size='A4')
{
	// Some checks
	$this->_dochecks();
	// Initialization of properties
